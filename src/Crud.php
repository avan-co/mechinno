        ...
        return [
            ...
            'desks' => [
                ...
                'fields' => [
                    ...
                    'usage_type' => [
                        'label' => 'نوع استفاده',
                        'type' => 'select',
                        'options' => ['formal' => 'رسمی', 'informal' => 'موقت', 'mixed' => 'ترکیبی'],
                        'required' => true,
                    ],
                    'notes' => ['label' => 'توضیحات', 'type' => 'textarea'],
            ...
            'charges' => [
                ...
                'fields' => [
                    ...
                    'rent_amount' => ['label' => 'مبلغ اجاره موقت', 'type' => 'number'],
            ...
            'rate_settings' => [
                ...
                'fields' => [
                    ...
                    'informal_rent_rate' => ['label' => 'نرخ اجاره موقت هر میز', 'type' => 'number', 'required' => true],
