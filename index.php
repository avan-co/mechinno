        ...
        <div class="main-wrap">
          ...
          <main class="content">
            ...
            <section id="overview" class="section active">
              ...
              <div class="grid two dashboard-panels dashboard-panels--priority">
                <article class="panel">
            ...
            <section id="teams" class="section">
              <div class="section-intro section-intro--purple">
                ...
                <div class="section-intro-copy"><p>هر نهاد را از دکمه <strong>پروفایل</strong> باز کنید — قرارداد، میز و بدهی هر سال در یکجا مدیریت می‌شود. برای ورود گروهی از CSV کنار «افزودن» استفاده کنید.</p></div>
              </div>
            ...
            <section id="meeting-rooms" class="section">
              ...
              <?php if (Access::isAdmin()): ?>
              <data-table title="رزرو — در انتظار تأیید" endpoint="api.php?resource=pending-room-reservations" data-workflow="meeting-rooms" data-workflow-type="room-reservation" data-table-key="pending-room-reservations" data-readonly data-per-page="10"></data-table>
              <?php endif; ?>
              <?php if (Access::canWrite()): ?>
              ...
              <?php endif; ?>
              <data-table title="رزروهای اتاق" endpoint="api.php?resource=room-reservations" data-no-add data-readonly data-per-page="10"></data-table>
